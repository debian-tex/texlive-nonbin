...
sub make_deb_control {
	...
	print CONTROL "Vcs-Git: https://github.com/debian-tex/texlive-nonbin.git [$package]\n";
	print CONTROL "Vcs-Browser: https://github.com/debian-tex/texlive-nonbin/tree/master/$package\n";
